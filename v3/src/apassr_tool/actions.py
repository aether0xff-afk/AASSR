...
MAX_QUERY_PARAMS_PER_ENDPOINT = 32
MAX_PARAM_NAMES_PER_ENDPOINT = 24
MAX_PROBE_VALUES_PER_ENDPOINT = 24
MAX_LOGIN_PATHS = 32
MAX_COMBO_POST_FIELDS = 12
MAX_COMBO_POSTS_PER_ENDPOINT = 16
MAX_JSON_FIELDS = 12
MAX_JSON_BODIES_PER_ENDPOINT = 16
MAX_MUTATED_VALUES = 24
MAX_MUTATION_CANDIDATES_PER_ENDPOINT = 48
MAX_FILE_SURFACE_CANDIDATES = 32
